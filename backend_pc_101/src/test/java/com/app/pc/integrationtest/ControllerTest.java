...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM pc_451.PetService");
    jdbcTemplate.execute("DELETE FROM pc_451.PetOwner");
    jdbcTemplate.execute("DELETE FROM pc_451.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM pc_451.Manager");
    jdbcTemplate.execute("DELETE FROM pc_451.Document");
    jdbcTemplate.execute("DELETE FROM pc_451.Pet");
     jdbcTemplate.execute("DELETE FROM pc_451.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM pc_451.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM pc_451.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM pc_451.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM pc_451.PetCareCenterPets");
